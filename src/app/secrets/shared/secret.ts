...
export const FormType = {
  ...
  card: [ FieldsBundle.title, FieldsBundle.number, FieldsBundle.owner, FieldsBundle.cardexpires, FieldsBundle.cvv, FieldsBundle.pin ],
  identity: [ FieldsBundle.title, FieldsBundle.number, FieldsBundle.name, FieldsBundle.birthday, FieldsBundle.issued, FieldsBundle.expires ],
